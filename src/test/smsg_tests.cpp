...
// test_eclipse --log_level=all  --run_test=smsg_tests
...
BOOST_AUTO_TEST_CASE(smsg_test)
{
    ...
    const std::string sTestMessage =
        "Eclipse is a STATE OF THE ART, Proof of Stake crypto currency, utilizing cutting edge technology, "
        "such as instant p2p encrypted messaging (EclipseChat), and anonymous dual-key stealth addresses (EclipseSend). "
