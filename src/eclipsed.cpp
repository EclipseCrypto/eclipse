...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("EclipseCrypto version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  eclipsed [options]                     " + "\n" +
                  "  eclipsed [options] <command> [params]  " + _("Send command to -server or eclipsed") + "\n" +
                  "  eclipsed [options] help                " + _("List commands") + "\n" +
                  "  eclipsed [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "eclipsecrypto:"))
                fCommandLine = true;
...
int main(int argc, char* argv[])
{
    ...
    // Connect eclipsed signal handlers
    noui_connect();
