#ifndef ECLIPSEBRIDGE_H
#define ECLIPSEBRIDGE_H
...
class EclipseBridge : public QObject
{
    Q_OBJECT
...
public:
    explicit EclipseBridge(EclipseGUI *window, QObject *parent = 0);
    ~EclipseBridge();
