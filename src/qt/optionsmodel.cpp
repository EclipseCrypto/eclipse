...
void OptionsModel::Init()
{
    ...
    nDisplayUnit = settings.value("nDisplayUnit", BitcoinUnits::EC).toInt();
    ...
    fAutoRedeemEclipse = settings.value("fAutoRedeemEclipse", false).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AutoRedeemEclipse:
            return fAutoRedeemEclipse;
        case MinRingSize:
            return nMinRingSize;
        case MaxRingSize:
            return nMaxRingSize;
...
QString OptionsModel::optionIDName(int row)
{
    ...
    case AutoRedeemEclipse: return "AutoRedeemEclipse";
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DisplayAddresses:
            ...
            emit displayUnitChanged(settings.value("nDisplayUnit", BitcoinUnits::EC).toInt());
            break;
        case DetachDatabases: {
        ...
        case AutoRingSize: {
            ...
            break;
        case AutoRedeemEclipse: {
            fAutoRedeemEclipse = value.toBool();
            settings.setValue("fAutoRedeemEclipse", fAutoRedeemEclipse);
            }
            break;
        case MinRingSize: {
...
bool OptionsModel::getAutoRedeemEclipse() { return fAutoRedeemEclipse; }
