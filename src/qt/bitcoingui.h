...
/**
  Eclipse GUI main class. This class represents the main window of the Eclipse UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class EclipseGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit EclipseGUI(QWidget *parent = 0);
    ~EclipseGUI();
