...
android {
    ...
    RESOURCES = eclipse.qrc

build_macosx64 {
    QMAKE_TARGET_BUNDLE_PREFIX = co.eclipsecrypto
...
contains(ECLIPSE_NEED_QT_PLUGINS, 1) {
    DEFINES += ECLIPSE_NEED_QT_PLUGINS
...
macx:ICON = src/qt/res/icons/eclipse.icns
macx:TARGET = "Eclipse"
